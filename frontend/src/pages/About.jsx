    ...
    <div data-testid="about-page">
      ...
      <section className="bg-surface py-20 md:py-28">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-xs uppercase tracking-[0.2em] text-[#7ACBA5] font-medium mb-4">About Devishiv</div>
      ...
      <section className="py-20 md:py-28">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <div className="text-xs uppercase tracking-[0.2em] text-[#7ACBA5] font-medium mb-3">Our mission</div>
            <h2 className="font-display text-3xl sm:text-4xl lg:text-5xl font-medium tracking-tight text-[#0F172A] leading-tight mb-6">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -left-6 bg-white rounded-2xl p-6 border border-border shadow-sm max-w-xs">
              <div className="flex items-center gap-3 mb-2">
                <div className="h-10 w-10 rounded-full bg-[#E4F4E4] grid place-items-center text-[#0A4273]">
                  <Award className="h-5 w-5" />
                </div>
                <div className="font-display text-base font-semibold text-[#0A4273]">NABH Certified</div>
              </div>
      ...
      <section className="py-20 md:py-24 bg-surface-alt">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="max-w-2xl mb-12">
            <div className="text-xs uppercase tracking-[0.2em] text-[#7ACBA5] font-medium mb-3">What we stand for</div>
            <h2 className="font-display text-3xl sm:text-4xl font-medium tracking-tight text-[#0F172A]">
            ...
            {VALUES.map((v) => {
              ...
              return (
                <div key={v.title} className="p-8 rounded-3xl bg-white border border-border" data-testid={`value-${v.title.toLowerCase().replace(/\s/g, "-")}`}>
                  <div className="h-12 w-12 rounded-2xl bg-[#0A4273] text-white grid place-items-center mb-6">
                    <Icon className="h-6 w-6" />
                  </div>
                  <h3 className="font-display text-xl font-medium text-[#0F172A] mb-3">{v.title}</h3>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="rounded-3xl border border-border p-10 md:p-14 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <div className="text-xs uppercase tracking-[0.18em] text-[#7ACBA5] font-medium mb-2">Address</div>
              <p className="text-base text-slate-700 leading-relaxed">{HOSPITAL.address}</p>
            </div>
            <div>
              <div className="text-xs uppercase tracking-[0.18em] text-[#7ACBA5] font-medium mb-2">Hours</div>
            ...
            <div>
              <div className="text-xs uppercase tracking-[0.18em] text-[#7ACBA5] font-medium mb-2">Reach us</div>
